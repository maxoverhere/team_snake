...
# import os.path
# print(os.listdir('.'))
# print(os.path.isfile('env/snak/sprites/head.png'))
# test =cv2.imread('env/snak/sprites/head.png', 0)
# print("sd",test)
# cv2.imshow('image',test)

sprites = {
    'head': cv2.imread('env/snak/sprites/head.png', 0) if cv2.imread('env/snak/sprites/head.png', 0) is not None else cv2.imread('sprites/head.png', 0),
    'body': cv2.imread('env/snak/sprites/body.png', 0) if cv2.imread('env/snak/sprites/body.png', 0) is not None else cv2.imread('sprites/body.png', 0),
    'turn': cv2.imread('env/snak/sprites/turn.png', 0) if cv2.imread('env/snak/sprites/turn.png', 0) is not None else cv2.imread('sprites/turn.png', 0),
    'fruit': cv2.imread('env/snak/sprites/fruit.png', 0) if cv2.imread('env/snak/sprites/fruit.png', 0) is not None else cv2.imread('sprites/fruit.png', 0),
    'tail': cv2.imread('env/snak/sprites/tail.png', 0) if cv2.imread('env/snak/sprites/tail.png', 0) is not None else cv2.imread('sprites/tail.png', 0),
}
